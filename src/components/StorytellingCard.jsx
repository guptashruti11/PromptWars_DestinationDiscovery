...
const StorytellingCard = ({ data, onDismiss }) => {
  ...
  return (
    <article 
      className="bg-neutral-800 border border-neutral-700/60 rounded-2xl p-6 shadow-xl relative overflow-hidden transition-all duration-300 hover:border-heritage-500/30 animate-fade-in-up"
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-neutral-700/60 pb-5 mb-6">
        ...
        {/* Audio control deck */}
        <div className="flex items-center gap-2 bg-neutral-900/80 p-2 rounded-xl border border-neutral-700/50 self-start md:self-center">
          <button
          ...
          {isSpeaking && (
            <button
              ...
              className="p-1.5 bg-neutral-800 hover:bg-neutral-700 text-neutral-400 hover:text-neutral-200 rounded-lg transition-colors"
      ...
      <section className="mb-8" aria-label="Sensory details">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Sight */}
          <div className="bg-neutral-900/40 p-4 rounded-xl border border-neutral-700/40 flex gap-3">
            <div className="p-2 bg-blue-500/10 text-blue-400 rounded-lg h-fit" aria-hidden="true">
          ...
          {/* Sound */}
          <div className="bg-neutral-900/40 p-4 rounded-xl border border-neutral-700/40 flex gap-3">
            <div className="p-2 bg-emerald-500/10 text-emerald-400 rounded-lg h-fit" aria-hidden="true">
          ...
          {/* Smell & Taste */}
          <div className="bg-neutral-900/40 p-4 rounded-xl border border-neutral-700/40 flex gap-3">
            <div className="p-2 bg-amber-500/10 text-amber-400 rounded-lg h-fit" aria-hidden="true">
      ...
      {/* Insider Tip Drawer */}
      {data.insiderTip && (
        <footer className="mt-8 bg-neutral-900/60 p-4 rounded-xl border-l-4 border-heritage-500 flex gap-3.5">
